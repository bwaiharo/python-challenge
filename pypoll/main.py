...
py_poll_csv = os.path.join(r'python-challenge\Resources\Election_data.csv')
voter = []
candidate = []
county = []
with open(py_poll_csv,"r") as py_file:
...
with open(r"python-challenge\Resources\Py_poll_output.csv","w") as file:
